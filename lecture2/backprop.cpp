//Back propagation cross check with a simple program : Ali   :: brew reinstall gnuplot --with-qt
#include <iostream>
#include<vector>
#include <list>
#include <cstdlib>
...
//Activation function and the derivative
...
int main(int argc, const char * argv[])
{
   ...
   fprintf(gp, "set terminal qt size 600,400 \n");
   fprintf(gp, "set grid \n");
   ...
   fprintf(gp1, "set terminal qt size 600,400 \n");
   fprintf(gp1, "set grid \n");
   fprintf(gp1, "set title '%s' \n", "Performance");
   fprintf(gp1, "set style line 1 lt 7 pt 11 ps 0.1 lc rgb 'green' lw 1 \n");
   fprintf(gp1, "set style line 2 lt 7 pt 11 ps 0.1 lc rgb 'red' lw 1 \n");
