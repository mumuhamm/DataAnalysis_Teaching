...
void CutAndPlot(string filename, bool mc=0, int trig=1, int bs=1, bool sb=0, bool draw=0){
  //trig=0 -> no trigger selection, trig=1 -> JpsiMu trig, trig=2 -> JpsiTkTk trig
  //bs==1 select Bs, bs==2 select B0, bs==0 select both
  //for sb=1 sidebands are selected, works only for bs so in the case sb==1 we force to select the bs
  if (sb==1) bs=1;
  ...
  TH1F *hangle_cospsi, *hangle_costheta, *hangle_phi, *hctau, *hctaue ;
  ...
  TH1F *hangle_cospsi_GEN, *hangle_costheta_GEN, *hangle_phi_GEN, *hctau_GEN;
  ...
  TH1F *hangle_cospsi_RES, *hangle_costheta_RES, *hangle_phi_RES, *hctau_RES;
  ...
  TProfile *hangle_cospsi_RESvsPT, *hangle_costheta_RESvsPT, *hangle_phi_RESvsPT, *hctau_RESvsPT;
  ...
  TH2F *hangle_cospsi_RESvsPTTH2, *hangle_costheta_RESvsPTTH2, *hangle_phi_RESvsPTTH2, *hctau_RESvsPTTH2;
  ...
  fChain->SetBranchAddress("isBs", &isBs);
  ...
  fChain->SetBranchAddress("B_MassNoRefit", &Bs_MassNoRefit);
  fChain->SetBranchAddress("B_MassFromSV", &Bs_MassFromSV);

  fChain->SetBranchAddress("Jpsi_MassNoRefit", &Jpsi_MassNoRefit);
  fChain->SetBranchAddress("Jpsi_MassFromSV", &Jpsi_MassFromSV);

  fChain->SetBranchAddress("PhiKstar_MassNoRefit", &Phi_MassNoRefit);
  fChain->SetBranchAddress("PhiKstar_MassFromSV", &Phi_MassFromSV);

  fChain->SetBranchAddress("HLT_MatchedJpsi", &HLT_MatchedJpsi);
  fChain->SetBranchAddress("HLT_MatchedTracks", &HLT_MatchedPhi);

  fChain->SetBranchAddress("Tag", &Tag);
  fChain->SetBranchAddress("MisTag", &MisTag);
  fChain->SetBranchAddress("MisTagErr", &MisTagErr);
  ...
  fChain->SetBranchAddress("ctau3D", &ctau3D);
  fChain->SetBranchAddress("ctauErr", &ctauErr);
  fChain->SetBranchAddress("ctau3DErr", &ctau3DErr);
  fChain->SetBranchAddress("B_VProb", &Bs_VProb);
  fChain->SetBranchAddress("Jpsi_VProb", &Jpsi_VProb);
  fChain->SetBranchAddress("PhiKstar_VProb", &Phi_VProb);
  fChain->SetBranchAddress("B_Mass", &Bs_Mass);
  fChain->SetBranchAddress("B_Pt", &Bs_Pt);
  fChain->SetBranchAddress("B_Eta", &Bs_Eta);
  fChain->SetBranchAddress("B_Phi", &Bs_Phi);
  ...
  fChain->SetBranchAddress("PhiKstar_Mass", &Phi_Mass);
  fChain->SetBranchAddress("PhiKstar_Pt", &Phi_Pt);
  fChain->SetBranchAddress("PhiKstar_Eta", &Phi_Eta);
  fChain->SetBranchAddress("PhiKstar_Phi", &Phi_Phi);
  fChain->SetBranchAddress("Bc_Mass", &Bc_Mass);
  ...
  fChain->SetBranchAddress("N_PV", &N_PV);
  ...
  fChain->SetBranchAddress("KmK_Pt", &Km_Pt);
  fChain->SetBranchAddress("KmK_Eta", &Km_Eta);
  fChain->SetBranchAddress("KmK_Phi", &Km_Phi);
  fChain->SetBranchAddress("KmK_Hits", &Km_Hits);
  fChain->SetBranchAddress("KpPi_Pt", &Kp_Pt);
  fChain->SetBranchAddress("KpPi_Eta", &Kp_Eta);
  fChain->SetBranchAddress("KpPi_Phi", &Kp_Phi);
  fChain->SetBranchAddress("KpPi_Hits", &Kp_Hits);
  ...
  fChain->SetBranchAddress("ctau_GEN", &ctau_GEN);
  fChain->SetBranchAddress("ctau3D_GEN", &ctau3D_GEN);
  fChain->SetBranchAddress("B_Mass_GEN", &Bs_Mass_GEN);
  fChain->SetBranchAddress("B_Pt_GEN", &Bs_Pt_GEN);
  fChain->SetBranchAddress("B_Eta_GEN", &Bs_Eta_GEN);
  fChain->SetBranchAddress("B_Phi_GEN", &Bs_Phi_GEN);
  ...
  fChain->SetBranchAddress("PhiKstar_Mass_GEN", &Phi_Mass_GEN);
  fChain->SetBranchAddress("PhiKstar_Pt_GEN", &Phi_Pt_GEN);
  fChain->SetBranchAddress("PhiKstar_Eta_GEN", &Phi_Eta_GEN);
  fChain->SetBranchAddress("PhiKstar_Phi_GEN", &Phi_Phi_GEN);
  ...
  fChain->SetBranchAddress("KmK_Pt_GEN", &Km_Pt_GEN);
  fChain->SetBranchAddress("KmK_Eta_GEN", &Km_Eta_GEN);
  fChain->SetBranchAddress("KmK_Phi_GEN", &Km_Phi_GEN);
  fChain->SetBranchAddress("KpPi_Pt_GEN", &Kp_Pt_GEN);
  fChain->SetBranchAddress("KpPi_Eta_GEN", &Kp_Eta_GEN);
  fChain->SetBranchAddress("KpPi_Phi_GEN", &Kp_Phi_GEN);
  ...
  if (bs==1) name=name+"_Bs_";
  if (bs==2) name=name+"_B0_";
  if (bs==0) name=name+"_BsAndB0_";
  ...
  hctau=new TH1F("ctau","ctau", 100, -.05, 0.5);
  hctaue=new TH1F("ctau Err","ctau Err", 100, 0, 0.01);
  ...
  if (bs==1)  hBsMass=new TH1F("BsMass","BsMass", 50, 5.2, 5.6);
  if (bs==2)  hBsMass=new TH1F("BsMass","BsMass", 50, 5.1, 5.45);
  if (bs==0)  hBsMass=new TH1F("BsMass","BsMass", 55, 5.1, 5.6);

  hBsPhi=new TH1F("BsPhi","BsPhi", 50, -3.2, 3.2);

  if (bs==1)  hBsMassFromSV=new TH1F("BsMassFromSV","BsMassFromSV", 50, 5.2, 5.6);
  if (bs==2)  hBsMassFromSV=new TH1F("BsMassFromSV","BsMassFromSV", 50, 5.1, 5.45);
  if (bs==0)  hBsMassFromSV=new TH1F("BsMassFromSV","BsMassFromSV", 55, 5.1, 5.6);

  if (bs==1)  hBsMassNoRefit=new TH1F("BsMassNoRefit","BsMassNoRefit", 50, 5.2, 5.6);
  if (bs==2)  hBsMassNoRefit=new TH1F("BsMassNoRefit","BsMassNoRefit", 50, 5.1, 5.45);
  if (bs==0)  hBsMassNoRefit=new TH1F("BsMassNoRefit","BsMassNoRefit", 55, 5.1, 5.6);
  ...
  if(bs==1) hPhiMass=new TH1F("PhiMass","PhiMass", 50, 0.98, 1.05);
  if(bs==2) hPhiMass=new TH1F("PhiMass","PhiMass", 50, 0.8, 1.05);
  if(bs==0) hPhiMass=new TH1F("PhiMass","PhiMass", 55, 0.8, 1.05);

  hPhiPhi=new TH1F("PhiPhi","PhiPhi", 50, -3.2, 3.2);

  if(bs==1)  hPhiMassFromSV=new TH1F("PhiMassFromSV","PhiMassFromSV", 50, 0.98, 1.05);
  if(bs==2)  hPhiMassFromSV=new TH1F("PhiMassFromSV","PhiMassFromSV", 50, 0.8, 1.05);
  if(bs==0)  hPhiMassFromSV=new TH1F("PhiMassFromSV","PhiMassFromSV", 55, 0.8, 1.05);

  if(bs==1)  hPhiMassNoRefit=new TH1F("PhiMassNoRefit","PhiMassNoRefit", 50, 0.98, 1.05);
  if(bs==2)  hPhiMassNoRefit=new TH1F("PhiMassNoRefit","PhiMassNoRefit", 50, 0.8, 1.05);
  if(bs==0)  hPhiMassNoRefit=new TH1F("PhiMassNoRefit","PhiMassNoRefit", 55, 0.8, 1.05);
  ...
  hangle_phi=new TH1F("angle_phi","angle_phi", 50, -TMath::Pi(), TMath::Pi());
  ...
  if (mc){
    ...
    hctau_GEN=new TH1F("ctau_GEN","ctau_GEN", 100, -.05, 0.5);

    hctau_RES=new TH1F("ctau_RES","ctau_RES", 200, -.02, 0.02);
    ...
    hctau_RESvsPT=new TProfile("ctau_RESvsPT","ctau_RESvsPT", 100,0,50, -.05, 0.05,"");
    ...
    hctau_RESvsPTTH2=new TH2F("ctau_RESvsPTTH2","ctau_RESvsPTTH2", 100,0,50, 100, -.05, 0.05);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (bs==2 && isBs) continue;
      if (bs==1 && !isBs) continue;//exclude the other candidate if one type is chosen
	...
	kp.SetPtEtaPhiM(Kp_Pt,Kp_Eta,Kp_Phi,KMASS);
      ...
      if (isBs==0){
	km.SetPtEtaPhiM(Km_Pt,Km_Eta,Km_Phi,KMASS);
	kp.SetPtEtaPhiM(Kp_Pt,Kp_Eta,Kp_Phi,PIMASS);
      }
      ...
      if (isBs==1 && (Phi_MassFromSV < 1.009 || Phi_MassFromSV > 1.029)) continue;
      if (isBs==0 && (Phi_MassFromSV < 0.85 || Phi_MassFromSV > 0.95)) continue;

      if (bs==1 && (Bs_MassFromSV > 5.65 || Bs_MassFromSV < 5.2)) continue;
      if (bs==2 && (Bs_MassFromSV > 5.45 || Bs_MassFromSV < 5.1)) continue;
      if (bs==0 && (Bs_MassFromSV > 5.65 || Bs_MassFromSV < 5.1)) continue;

      if (sb && Bs_MassFromSV > 5.28 && Bs_MassFromSV < 5.45) continue; // Sideband selection

      if (trig==1){//i.e JpsiMu
      //analysis cuts
	
	if (abs(mum.Eta()) > 2.4) continue;
	if (mum.Pt() < 3.5) continue;

	if (abs(mup.Eta()) > 2.4) continue;
	if (mup.Pt() < 3.5) continue;

	if (kp.Pt() < 1.2 || km.Pt() < 1.2) continue;
	
	if (abs(km.Eta()) > 2.5 || abs(kp.Eta())>2.5) continue;

	if (ctau< 0.007) continue; //for JpsiMu trigger

	if (Bs.Pt() < 11) continue;
      	
	if (abs(Bs.Eta()) >2.4) continue;

	if (Bs_VProb < 0.001) continue;
	...
	pass=true;
      ...
      if (trig==2){
	//analysis cuts
	if (abs(mum.Eta()) > 2.5) continue;
	
	if (mum.Pt() < 3.6) continue;

	if (abs(mup.Eta()) > 2.5) continue;
	
	if (mup.Pt() < 3.6) continue;

	if (kp.Pt() < 1.0 || km.Pt() < 1.0) continue;

	if (abs(km.Eta()) > 2.5 || abs(kp.Eta())>2.5) continue;
	
	if (ctau< 0.02) continue;
	
	if (ctau/ctauErr < 3) continue;
	
	if (Bs.Pt() < 10) continue;
	...
	hctau_RESvsPT->Fill(Bs_Pt,ctau-ctau_GEN);
	...
	hctau_RESvsPTTH2->Fill(Bs_Pt,ctau-ctau_GEN);
